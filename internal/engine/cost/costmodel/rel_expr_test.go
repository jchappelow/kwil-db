...
func Test_RelExpr_String(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "test",
			r:    &RelExpr{},
			want: "LogicalPlan <nil>, Rows: 0, Cost: 0",
		},
	}
...
func TestEstimateCost(t *testing.T) {
	...
	// 	wt: "Sort: id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
	// 		"  Projection: users.username, users.age, Rows: 5, Cost: 0\n" +
	// 		"    Filter: users.age > 20, Rows: 5, Cost: 0\n" +
	// 		"      Scan: users, Rows: 5, Cost: 0\n",
	// },
...
func TestBuildRelExpr(t *testing.T) {
	...
	tests := []struct {
		...
		/////////////////////// no relation
		{
			name: "select int",
			sql:  "SELECT 1",
			wt: "Projection: 1, Rows: 0, Cost: 0\n" +
				"  NoRelationOp, Rows: 0, Cost: 0\n",
		},
		{
			name: "select string",
			sql:  "SELECT 'hello'",
			wt: "Projection: 'hello', Rows: 0, Cost: 0\n" +
				"  NoRelationOp, Rows: 0, Cost: 0\n",
		},
		{
			name: "select value expression",
			sql:  "SELECT 1+2",
			wt: "Projection: 1 + 2, Rows: 0, Cost: 0\n" +
				"  NoRelationOp, Rows: 0, Cost: 0\n",
		},
		...
		/////////////////////// one relation
		{
			...
			wt: "Sort: id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"  Projection: users.id, users.username, users.age, users.state, users.wallet, Rows: 5, Cost: 0\n" +
				"    Scan: users, Rows: 5, Cost: 0\n",
		},
		//{ // TODO?
		...
		},
		{
			...
			wt: "Sort: id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"  Projection: users.username AS name, Rows: 5, Cost: 0\n" +
				"    Scan: users, Rows: 5, Cost: 0\n",
		},
		{
			...
			wt: "Sort: id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"  Projection: users.username, users.age + 10, Rows: 5, Cost: 0\n" +
				"    Scan: users, Rows: 5, Cost: 0\n",
		},
		{
			name: "select with where",
		...
		},
		{
			...
			wt: "Sort: id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"  Projection: users.username, users.age, Rows: 5, Cost: 0\n" +
				"    Filter: users.age > 20 AND users.state = 'CA', Rows: 5, Cost: 0\n" +
				"      Scan: users, Rows: 5, Cost: 0\n",
		},
		//{
		...
		//},
		{
			...
			wt: "Limit: skip=0, fetch=10, Rows: 0, Cost: 0\n" +
				"  Sort: id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"    Projection: users.username, users.age, Rows: 5, Cost: 0\n" +
				"      Scan: users, Rows: 5, Cost: 0\n",
		},
		{
			...
			wt: "Limit: skip=5, fetch=10, Rows: 0, Cost: 0\n" +
				"  Sort: id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"    Projection: users.username, users.age, Rows: 5, Cost: 0\n" +
				"      Scan: users, Rows: 5, Cost: 0\n",
		},
		{
			...
			wt: "Sort: age ASC NULLS LAST, id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"  Projection: users.username, users.age, Rows: 5, Cost: 0\n" +
				"    Scan: users, Rows: 5, Cost: 0\n",
		},
		{
			...
			wt: "Sort: age DESC NULLS LAST, id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"  Projection: users.username, users.age, Rows: 5, Cost: 0\n" +
				"    Scan: users, Rows: 5, Cost: 0\n",
		},
		/////////////////////// subquery
		{
			...
			wt: "Sort: id ASC NULLS LAST, username ASC NULLS LAST, age ASC NULLS LAST, state ASC NULLS LAST, wallet ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"  Projection: users.username, users.age, Rows: 0, Cost: 0\n" +
				"    Sort: id ASC NULLS LAST, Rows: 0, Cost: 0\n" +
				"      Projection: users.id, users.username, users.age, users.state, users.wallet, Rows: 5, Cost: 0\n        Scan: users, Rows: 5, Cost: 0\n",
		},
		/////////////////////// two relations
