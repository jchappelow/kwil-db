...
func AddConfigFlags(flagSet *pflag.FlagSet, cfg *KwildConfig) {
	...
	flagSet.BoolVar(&cfg.AppCfg.NoTLS, "app.admin_notls", cfg.AppCfg.NoTLS, "do not enable TLS on admin server (automatically disabled for unix socket or loopback listen addresses)")
